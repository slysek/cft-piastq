...
class PiastQSampler:
    ...
    def _run_managed(
        ...
        *,
        ...
        owner = _required_owner_text(backend.owner)
        payload: dict[str, Any] = {
            ...
            "shots": shots,
            "circuits": [
                _managed_circuit_payload(circuit)
...
def _managed_circuit_payload(circuit: QuantumCircuit) -> dict[str, Any]:
    return {"qpy_base64": circuit_to_qpy_base64(circuit)}
